...
const wallnut = new Personagens('./assets/img/personagens/plants/wallnut.webp', 30000, 50, 30, 0, 30);
const cherrybomb = new Personagens('./assets/img/personagens/plants/cherrybomb.webp', 20000, 150, 15, 0, 30); //ataque muda para 0 
